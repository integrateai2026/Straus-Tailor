                  ...
                  {[
                    {
                      ...
                      body: 'Transactional/service messages from Straus Tailor Shop may include order updates, pickup reminders, customer service replies, and review requests. Msg frequency varies, usually a few messages per order. Msg/data rates may apply. Reply HELP for help or STOP to opt out.',
                    },
                    {
                      key: 'smsMarketing' as const,
                      bold: 'Yes, send me shop updates and offers.',
                      body: 'Promotional/marketing messages from Straus Tailor Shop may include shop updates, seasonal updates, and occasional offers. Msg frequency up to 2/month. Msg/data rates may apply. Reply HELP for help or STOP to opt out.',
                    },
                  ].map(({ key, bold, body }) => (
